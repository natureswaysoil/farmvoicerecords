-- QuickBooks integration schema already applied to the FarmVoice Supabase project.
-- Keep this file as the repository record of the production schema change.
